...
const dom = {
    ...
    dropZone: byId('upload-section'),
    fileInput: byId('file-input'),
    bookInfo: byId('dummy-bookinfo'),
    bookName: byId('book-name-display'),
    bookPages: byId('dummy-bookpages'),
    closeBookBtn: byId('close-sidebar'),
    thumbHeader: byId('dummy-thumbheader'),
    thumbList: byId('dummy-thumblist'),
    themeBtn: byId('theme-toggle'),
    themeIcon: byId('theme-toggle'),
    themeLabel: byId('dummy-themelabel'),
    pageNav: byId('dummy-pagenav'),
    ...
    loader: byId('loader'),
    loaderMsg: byId('loader-msg'),
    pageContainer: byId('page-wrap'),
    pageWrap: byId('page-wrap'),
    pdfCanvas: byId('pdf-canvas'),
    textLayer: byId('text-layer'),
    viewerWrap: document.querySelector('.main-content') || document.body,
    voiceSel: byId('voice-select'),
    playBtn: byId('play-btn'),
    stopBtn: byId('dummy-stop'),
    skipBack: byId('prev-btn'),
    skipFwd: byId('next-btn'),
    spdDn: byId('dummy-spddn'),
    spdUp: byId('dummy-spdup'),
...
function showLoader(msg) { dom.loaderMsg.textContent = msg; dom.welcome.style.display = 'none'; dom.loader.style.display = 'flex'; dom.pageContainer.style.display = 'none'; }
